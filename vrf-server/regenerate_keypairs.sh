...
echo "Generating feePayer keypair..."
solana-keygen new --no-bip39-passphrase -o feepayer-keypair.json -f
...
echo "  ./run_vrf_server.sh --program-id 'BfwfooykCSdb1vgu6FcP75ncUgdcdt4ciUaeaSLzxM4D' --feepayer-keypair feepayer-keypair.json --vrf-keypair vrf-keypair.json" 