...
pub fn handler(ctx: Context<LzReceiveTypes>, params: LzReceiveParams) -> Result<Vec<LzAccount>> {
    ...
    msg!("LzReceiveTypes called for src_eid: {}", params.src_eid);
    msg!("Sender: {:?}", params.sender);
    msg!("Nonce: {}", params.nonce);
    msg!("GUID: {:?}", params.guid);
    msg!("Message size: {}", params.message.len());
    msg!("Returning {} accounts", accounts.len());
